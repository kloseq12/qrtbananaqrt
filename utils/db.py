...
async def init_economy_schema():
    ...
    включая бизнес, инвентарь, эффекты пользователей и логи кейсов.
    """
    async with aiosqlite.connect(DB_PATH) as db:
        # Включаем поддержку внешних ключей
        await db.execute("PRAGMA foreign_keys = ON")
        
        # Таблица для бизнесов пользователей
        await db.execute('''
        ...
        # Таблица для хранения активных эффектов пользователей
        await db.execute('''
        ...
        # Таблица для логирования открытия кейсов
        await db.execute('''
